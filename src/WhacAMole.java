...
public class WhacAMole {
    ...
    JFrame frame = new JFrame("Whac A Mole by M.Rofiq Fadilah");
	...
	frame.setSize(boardWidth, boardHeight);
	    ...
	    textLabel.setText("Score Anda : " + Integer.toString(score));
            ...
            tile.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (tile == currMoleTile) {
		                ...
		                textLabel.setText("Game Berakhir Dengan Score : " + Integer.toString(score));
                        setMoleTimer.stop();
                        setPlantTimer.stop();
                        for (int i = 0; i < 9; i++) {
